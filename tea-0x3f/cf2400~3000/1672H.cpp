...
// guess2: 0相当于往下走（因为0如果要匹配后面的1，必须前面的0消除掉），1相当于往上走（匹配前面的0，那么前面的0肯定要消除掉）
// guess3: 找到 [l,r] 区间中所有小于 h[l] 的点上升以及大于 h[l] 的下降，它们的和 + 1
// guess4: 找到上下起伏的总的波动数/2?
