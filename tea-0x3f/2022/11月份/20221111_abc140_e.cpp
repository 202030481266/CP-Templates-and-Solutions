// Problem: E - Second Sum
// Contest: AtCoder - AtCoder Beginner Contest 140
...
void solve() {
	int n;
	read(n);
	vi arr(n + 1), pos(n + 1), pre(n + 2), nxt(n + 2);
	...
	ll ans = 0;
	for (int i = 1; i <= n; ++i) {
		int l1, l2, r1, r2, p = pos[i];
		l1 = pre[p];
		l2 = pre[l1];
		r1 = nxt[p];
		r2 = nxt[r1];
		// (l2, l1], [r1, r2)
		ans += 1ll * (r1 - p) * (l1 - l2) * i;
		ans += 1ll * (p - l1) * (r2 - r1) * i;
		// l1, p, r1
		pre[r1] = l1;
		nxt[l1] = r1;
	}
