...
struct p3
{
    ...
    bool operator == (p3 a) const
    {
        return sign(a.x - x) == 0 && sign(a.y - y) == 0 && sign(a.z - z) == 0;
    }
    bool operator != (p3 a) const
    {
        return !(*this == a);
...
inline double dist2(p3 a, p3 b)
{
    return dot(a - b, a - b);
}
inline double dist(p3 a, p3 b)
{
    return sqrt(dot(a - b, a - b));
}
...
line3d perp_through(plane p, p3 o)
{
    return line3d(o, o + p.n);
}
// returns the plane perpendicular to line l and passing through point o
plane perp_through(line3d l, p3 o)
{
    return plane(l.d, o);
}
