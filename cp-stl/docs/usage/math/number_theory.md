...
- 模乘使用 GNU/Clang 的 __int128，避免 long long 乘积先溢出。
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File cp-stl/tools/cp.ps1 -Action Run -Source "cp-stl/examples/math/number_theory.cpp"
```
